package loggerbird.models

import com.google.gson.JsonArray
import com.google.gson.JsonObject
import loggerbird.models.api.clubhouse.ClubHouseEpicModel
import loggerbird.models.api.clubhouse.ClubhouseProjectModel
import loggerbird.models.api.github.*
...
import loggerbird.models.api.jira.*
...
//    fun getJiraIssueList(): Call<JsonObject>
    ...
    fun createTrelloIssue(
        @Body jsonObject: JsonObject, @Query("key") key: String, @Query("token") token: String, @Query(
            "idList"
        ) idList: String
    ): Call<JsonObject>
    ...
    @Multipart
    @POST("files.upload")
    fun setSlackAttachments(@Part file: MultipartBody.Part,@Query("channels") channels:String): Call<JsonObject>
}
...
//Custom recyclerView loggerbird.adapter class for asana attachment.
/**
 ...
 */
internal class RecyclerViewAsanaAttachmentAdapter(
    private val fileList: ArrayList<RecyclerViewModel>,
    private val context: Context,
    private val activity: Activity,
    private val rootView: View
) :
    RecyclerView.Adapter<RecyclerViewAsanaAttachmentAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
            LayoutInflater.from(parent.context).inflate(
                R.layout.recycler_view_asana_item,
                parent,
                false
            )
        )
    ...
    //Inner ViewHolder class for RecyclerViewAsanaAttachmentAdapter class.
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        internal fun bindItems(
            ...
            attachmentAdapter: RecyclerViewAsanaAttachmentAdapter,
            position: Int,

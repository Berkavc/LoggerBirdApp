...
//Custom recyclerView loggerbird.adapter class for github label.
/**
 ...
 */
internal class RecyclerViewGithubLabelAdapter(
    ...
    //Inner ViewHolder class for RecyclerViewGithubLabelAdapter class.
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        internal fun bindItems(
            ...
            labelAdapter: RecyclerViewGithubLabelAdapter,
            position: Int,
        ...
        /**
         * This method is used for initializing button clicks of buttons that are inside in the recycler_view_github_label_popup.
         * @param labelList is used for getting reference of the list of labels that will be used in recyclerView.
         * @param position is used for getting reference of the current position of the item.
         * @param labelAdapter is used for getting reference of the custom recyclerView loggerbird.adapter class.
         */
        ...
        /**
         * This method is used for removing recycler_view_github_label_popup from window.
         */

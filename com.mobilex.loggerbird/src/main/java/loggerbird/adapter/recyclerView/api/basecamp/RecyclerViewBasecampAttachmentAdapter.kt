...
//Custom loggerbird.adapter recyclerView class for basecamp attachment.
/**
 ...
 */
internal class RecyclerViewBasecampAttachmentAdapter(
    private val fileList: ArrayList<RecyclerViewModel>,
    private val context: Context,
    private val activity: Activity,
    private val rootView: View
) :
    RecyclerView.Adapter<RecyclerViewBasecampAttachmentAdapter.ViewHolder>() {
    ...
    //Inner ViewHolder class for RecyclerViewBasecampAttachmentAdapter class.
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        internal fun bindItems(
            ...
            attachmentAdapter: RecyclerViewBasecampAttachmentAdapter,
            position: Int,
        ...
        /**
         * This method is used for initializing button clicks of buttons that are inside in the recycler_view_basecamp_item_popup.
         * @param fileList is used for getting reference of the list of files that will be used in recyclerView.
         * @param position is used for getting reference of the current position of the item.
         * @param attachmentAdapter is used for getting reference of the custom recyclerView loggerbird.adapter class.
         */
        private fun buttonClicksBasecampPopup(
            fileList: ArrayList<RecyclerViewModel>,
            position: Int,
            attachmentAdapter: RecyclerViewBasecampAttachmentAdapter
        ) {
        ...
        /**
         * This method is used for removing recycler_view_basecamp_item_popup from window.
         */

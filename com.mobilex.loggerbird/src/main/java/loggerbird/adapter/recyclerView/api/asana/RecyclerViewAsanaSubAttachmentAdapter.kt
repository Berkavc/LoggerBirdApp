...
//Custom recyclerView loggerbird.adapter class for asana sub-task attachment.
/**
 ...
 */
internal class RecyclerViewAsanaSubAttachmentAdapter(
    private val fileList: ArrayList<RecyclerViewModel>,
    private val context: Context,
    private val activity: Activity,
    private val rootView: View
) :
    RecyclerView.Adapter<RecyclerViewAsanaSubAttachmentAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
            LayoutInflater.from(parent.context).inflate(
                R.layout.recycler_view_asana_sub_item,
                parent,
                false
            )
        )
    ...
    //Inner ViewHolder class for RecyclerViewSubAsanaAttachmentAdapter class.
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        internal fun bindItems(
            ...
            attachmentAdapter: RecyclerViewAsanaSubAttachmentAdapter,
            position: Int,
        ...
        private fun removeItemPopup(
            ...
            try {
                viewRecyclerViewItems = LayoutInflater.from(activity)
                    .inflate(
                        R.layout.recycler_view_asana_item_popup,
        ...
        /**
         * This method is used for initializing button clicks of buttons that are inside in the recycler_view_asana_item_popup.
         * @param fileList is used for getting reference of the list of files that will be used in recyclerView.
         * @param position is used for getting reference of the current position of the item.
         * @param attachmentAdapter is used for getting reference of the custom recyclerView loggerbird.adapter class.
         */
        private fun buttonClicksAsanaPopup(
            fileList: ArrayList<RecyclerViewModel>,
            position: Int,
            attachmentAdapter: RecyclerViewAsanaSubAttachmentAdapter
        ) {
        ...
        /**
         * This method is used for removing recycler_view_asana_item_popup from window.
         */

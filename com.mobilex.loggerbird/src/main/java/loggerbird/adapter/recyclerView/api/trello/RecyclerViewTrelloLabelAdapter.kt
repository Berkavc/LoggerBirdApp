...
//Custom recyclerView loggerbird.adapter class for trello label.
/**
 ...
 */
internal class RecyclerViewTrelloLabelAdapter(
    ...
    //Inner ViewHolder class for RecyclerViewTrelloLabelAdapter class.
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        internal fun bindItems(
            ...
            labelAdapter: RecyclerViewTrelloLabelAdapter,
            position: Int,
        ...
        private fun buttonClicksTrelloPopup(
            trelloList: ArrayList<RecyclerViewModelLabel>,
            position: Int,

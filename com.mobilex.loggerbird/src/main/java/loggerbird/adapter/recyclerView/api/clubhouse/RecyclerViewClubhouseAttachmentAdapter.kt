package loggerbird.adapter.recyclerView.api.clubhouse
...
//Custom recyclerView loggerbird.adapter class for clubhouse attachment.
/**
 ...
 */
internal class RecyclerViewClubhouseAttachmentAdapter(
    private val fileList: ArrayList<RecyclerViewModel>,
    private val context: Context,
    private val activity: Activity,
    private val rootView: View
) : RecyclerView.Adapter<RecyclerViewClubhouseAttachmentAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
            LayoutInflater.from(parent.context).inflate(
                R.layout.recycler_view_clubhouse_item,
                parent,
                false
            )
        )
    ...
    //Inner ViewHolder class for RecyclerViewClubhouseAttachmentAdapter class.
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        internal fun bindItems(
            ...
            attachmentAdapter: RecyclerViewClubhouseAttachmentAdapter,
            position: Int,
        ...
        private fun removeItemPopup(
            ...
            try {
                viewRecyclerViewItems = LayoutInflater.from(activity)
                    .inflate(
                        R.layout.recycler_view_clubhouse_item_popup,
                    ...
                    if (windowManagerRecyclerViewItemPopup != null) {
                        ...
                        textViewTitle =
                            viewRecyclerViewItems.findViewById(R.id.textView_recycler_view_clubhouse_title)
                        buttonYes =
                            viewRecyclerViewItems.findViewById(R.id.button_recycler_view_clubhouse_yes)
                        buttonNo =
                            viewRecyclerViewItems.findViewById(R.id.button_recycler_view_clubhouse_no)
                        buttonClicksClubhousePopup(
                            attachmentAdapter = attachmentAdapter,
                            fileList = fileList,
                            position = position
                        )
                ...
                LoggerBird.callExceptionDetails(
                    exception = e,
                    tag = Constants.recyclerViewClubhouseAdapterTag
                )
            }
        }

        /**
         * This method is used for initializing button clicks of buttons that are inside in the recycler_view_clubhouse_item_popup.
         * @param fileList is used for getting reference of the list of files that will be used in recyclerView.
         * @param position is used for getting reference of the current position of the item.
         * @param attachmentAdapter is used for getting reference of the custom recyclerView loggerbird.adapter class.
         */
        private fun buttonClicksClubhousePopup(
            fileList: ArrayList<RecyclerViewModel>,
            position: Int,
            attachmentAdapter: RecyclerViewClubhouseAttachmentAdapter
        ) {
        ...
        /**
         * This method is used for removing recycler_view_clubhouse_item_popup from window.
         */

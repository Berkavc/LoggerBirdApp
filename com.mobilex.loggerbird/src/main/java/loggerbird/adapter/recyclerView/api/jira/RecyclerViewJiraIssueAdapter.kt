...
import loggerbird.models.recyclerView.RecyclerViewModelIssue
import loggerbird.services.LoggerBirdService

//Custom recyclerView loggerbird.adapter class for jira issues.
/**
 * @param issueList is for getting the list of issues that will be used in recyclerView.
 ...
 */
internal class RecyclerViewJiraIssueAdapter(
    ...
    //Inner ViewHolder class for RecyclerViewJiraIssueAdapter class.
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
         ...
         * @param issueAdapter is used for getting reference of the custom recyclerView loggerbird.adapter class.
         * @param position is used for getting reference of the current position of the item.
         * @param issueList is used for getting reference of the list of issues that will be used in recyclerView.
         * @param context is for getting reference from the application context.
         * @param activity is for getting reference of current activity in the application.
         * @param rootView is for getting reference of the view that is in the root of current activity.
         */
        internal fun bindItems(
            ...
            issueAdapter: RecyclerViewJiraIssueAdapter,
            position: Int,
        ...
        /**
         * This method is used for initializing button clicks of buttons that are inside in the recycler_view_jira_issue_popup.
         * @param issueList is used for getting reference of the list of issues that will be used in recyclerView.
         * @param position is used for getting reference of the current position of the item.
         * @param issueAdapter is used for getting reference of the custom recyclerView loggerbird.adapter class.
         */
        private fun buttonClicksJiraPopup(
            issueList: ArrayList<RecyclerViewModelIssue>,
            position: Int,
            issueAdapter: RecyclerViewJiraIssueAdapter
        ) {
            buttonYes.setSafeOnClickListener {
                ...
                if (issueList.size <= 0) {
                    LoggerBirdService.loggerBirdService.textViewJiraIssueList.visibility = View.GONE
                    LoggerBirdService.loggerBirdService.imageViewJiraIssueList.visibility = View.GONE
                }
                removePopupLayout()
            }
        ...
        /**
         * This method is used for removing recycler_view_jira_issue from window.
         */

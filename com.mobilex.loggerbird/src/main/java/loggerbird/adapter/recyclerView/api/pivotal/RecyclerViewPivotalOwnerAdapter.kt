...
//Custom recyclerView loggerbird.adapter class for pivotal owner.
/**
...
internal class RecyclerViewPivotalOwnerAdapter(
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
         ...
         * @param ownerAdapter is used for getting reference of the custom recyclerView loggerbird.adapter class.

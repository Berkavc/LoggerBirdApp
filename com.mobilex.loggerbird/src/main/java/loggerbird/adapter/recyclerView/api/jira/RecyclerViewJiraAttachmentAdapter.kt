...
//Custom recyclerView loggerbird.adapter class for jira attachment.
/**
 ...
 */
internal class RecyclerViewJiraAttachmentAdapter(
    private val fileList: ArrayList<RecyclerViewModel>,
    private val context: Context,
    private val activity: Activity,
    private val rootView: View
) :
    RecyclerView.Adapter<RecyclerViewJiraAttachmentAdapter.ViewHolder>() {
    ...
    //Inner ViewHolder class for RecyclerViewJiraAttachmentAdapter class.
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        internal fun bindItems(
            ...
            attachmentAdapter: RecyclerViewJiraAttachmentAdapter,
            position: Int,
        ...
        /**
         * This method is used for initializing button clicks of buttons that are inside in the recycler_view_jira_item_popup.
         * @param fileList is used for getting reference of the list of files that will be used in recyclerView.
         * @param position is used for getting reference of the current position of the item.
         * @param attachmentAdapter is used for getting reference of the custom recyclerView loggerbird.adapter class.
         */
        ...
        /**
         * This method is used for removing recycler_view_jira_item_popup from window.
         */

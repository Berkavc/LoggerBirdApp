package loggerbird.adapter.recyclerView.api.gitlab
...
//Custom recyclerView loggerbird.adapter class for gitlab attachment.
/**
 ...
 */
internal class RecyclerViewGitlabAttachmentAdapter(
    private val fileList: ArrayList<RecyclerViewModel>,
    private val context: Context,
    private val activity: Activity,
    private val rootView: View
) : RecyclerView.Adapter<RecyclerViewGitlabAttachmentAdapter.ViewHolder>() {
    ...
    //Inner ViewHolder class for RecyclerViewGitlabAttachmentAdapter class.
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        internal fun bindItems(
            ...
            attachmentAdapter: RecyclerViewGitlabAttachmentAdapter,
            position: Int,
        ...
        /**
         * This method is used for initializing button clicks of buttons that are inside in the recycler_view_gitlab_item_popup.
         * @param fileList is used for getting reference of the list of files that will be used in recyclerView.
         * @param position is used for getting reference of the current position of the item.
         * @param attachmentAdapter is used for getting reference of the custom recyclerView loggerbird.adapter class.
         */
        ...
        /**
         * This method is used for removing recycler_view_gitlab_item_popup from window.
         */

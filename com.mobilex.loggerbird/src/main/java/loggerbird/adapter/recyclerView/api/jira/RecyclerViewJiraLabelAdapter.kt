...
//Custom recyclerView loggerbird.adapter class for jira label.
/**
 ...
 */
internal class RecyclerViewJiraLabelAdapter(
    private val labelList: ArrayList<RecyclerViewModelLabel>,
    private val context: Context,
    private val activity: Activity,
    private val rootView: View
) :
    RecyclerView.Adapter<RecyclerViewJiraLabelAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
            LayoutInflater.from(parent.context).inflate(
                R.layout.recycler_view_jira_label_item,
                parent,
                false
            )
        )
    ...
    //Inner ViewHolder class for RecyclerViewJiraLabelAdapter class.
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        internal fun bindItems(
            ...
            labelAdapter: RecyclerViewJiraLabelAdapter,
            position: Int,
        ...
        private fun removeItemPopup(
            ...
            try {
                viewRecyclerViewItems = LayoutInflater.from(activity)
                    .inflate(
                        R.layout.recycler_view_jira_label_popup,
        ...
        /**
         * This method is used for initializing button clicks of buttons that are inside in the recycler_view_jira_label_popup.
         * @param labelList is used for getting reference of the list of labels that will be used in recyclerView.
         * @param position is used for getting reference of the current position of the item.
         * @param labelAdapter is used for getting reference of the custom recyclerView loggerbird.adapter class.
         */
        private fun buttonClicksLabelPopup(
            labelList: ArrayList<RecyclerViewModelLabel>,
            position: Int,
            labelAdapter: RecyclerViewJiraLabelAdapter
        ) {
            buttonYes.setSafeOnClickListener {
                ...
                if (labelList.size <= 0) {
                    LoggerBirdService.loggerBirdService.textViewJiraLabelList.visibility = View.GONE
                    LoggerBirdService.loggerBirdService.imageViewJiraLabelList.visibility = View.GONE
                }
                removePopupLayout()
            }
        ...
        /**
         * This method is used for removing recycler_view_jira_label from window.
         */

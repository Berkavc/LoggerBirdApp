...
//Custom recyclerView loggerbird.adapter class for github attachment.
/**
 ...
 */
internal class RecyclerViewGithubAttachmentAdapter(
    private val fileList: ArrayList<RecyclerViewModel>,
    private val context: Context,
    private val activity: Activity,
    private val rootView: View
) :
    RecyclerView.Adapter<RecyclerViewGithubAttachmentAdapter.ViewHolder>() {
    ...
    //Inner ViewHolder class for RecyclerViewGithubAttachmentAdapter class.
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
       ...
       internal fun bindItems(
            ...
            attachmentAdapter: RecyclerViewGithubAttachmentAdapter,
            position: Int,
            ...
            try {
                viewRecyclerViewItems = LayoutInflater.from(activity)
                    ...
                    if (windowManagerRecyclerViewItemPopup != null) {
                        ...
                        buttonClicksGithubPopup(attachmentAdapter = attachmentAdapter , fileList = fileList , position = position)
                    }
            } catch (e: Exception) {
                e.printStackTrace()
        ...
        /**
         * This method is used for initializing button clicks of buttons that are inside in the recycler_view_github_item_popup.
         * @param fileList is used for getting reference of the list of files that will be used in recyclerView.
         * @param position is used for getting reference of the current position of the item.
         * @param attachmentAdapter is used for getting reference of the custom recyclerView loggerbird.adapter class.
         */
        private fun buttonClicksGithubPopup(fileList: ArrayList<RecyclerViewModel>, position: Int, attachmentAdapter: RecyclerViewGithubAttachmentAdapter) {
        ...
        /**
         * This method is used for removing recycler_view_github_item_popup from window.
         */

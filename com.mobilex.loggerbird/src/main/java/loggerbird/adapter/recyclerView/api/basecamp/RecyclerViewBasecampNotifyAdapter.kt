...
import loggerbird.models.recyclerView.RecyclerViewModelNotify
import loggerbird.services.LoggerBirdService

//Custom recyclerView loggerbird.adapter class for basecamp notify.
/**
...
internal class RecyclerViewBasecampNotifyAdapter(
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
         ...
         * @param notifyAdapter is used for getting reference of the custom recyclerView loggerbird.adapter class.
        ...
        private fun buttonClicksBasecampNotifyPopup(
            ...
            buttonYes.setSafeOnClickListener {
                ...
                if (notifyList.size <= 0) {
                    LoggerBirdService.loggerBirdService.textViewBasecampNotifyList.visibility =
                        View.GONE
                    LoggerBirdService.loggerBirdService.imageViewBasecampNotifyList.visibility =
                        View.GONE
                }
            }

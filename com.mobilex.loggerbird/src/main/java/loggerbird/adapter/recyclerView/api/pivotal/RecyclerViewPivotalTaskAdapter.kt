...
import loggerbird.models.recyclerView.RecyclerViewModelTask
import loggerbird.services.LoggerBirdService

//Custom recyclerView loggerbird.adapter class for pivotal task.
/**
...
internal class RecyclerViewPivotalTaskAdapter(
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
         ...
         * @param taskAdapter is used for getting reference of the custom recyclerView loggerbird.adapter class.
        ...
        private fun buttonClicksPivotalTaskPopup(
            ...
            buttonYes.setSafeOnClickListener {
                ...
                if (taskList.size <= 0) {
                    LoggerBirdService.loggerBirdService.textViewPivotalTasksList.visibility =
                        View.GONE
                    LoggerBirdService.loggerBirdService.imageViewPivotalTaskList.visibility =
                        View.GONE
                }
                removePopupLayout()
            }

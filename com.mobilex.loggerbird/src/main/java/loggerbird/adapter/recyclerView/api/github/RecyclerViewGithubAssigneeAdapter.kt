...
//Custom recyclerView loggerbird.adapter class for github assignee.
/**
        ...
        private fun buttonClicksGithubPopup(
            ...
            buttonYes.setSafeOnClickListener {
                ...
                if (assigneeList.size <= 0) {
                    LoggerBirdService.loggerBirdService.textViewGithubAssigneeList.visibility =
                        View.GONE
                    LoggerBirdService.loggerBirdService.imageViewGithubAssigneeList.visibility =
                        View.GONE
                }
                removePopupLayout()
            }

...
//Custom recyclerView loggerbird.adapter class for pivotal blocker.
/**
...
internal class RecyclerViewPivotalBlockerAdapter(
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
         ...
         * @param blockerAdapter is used for getting reference of the custom recyclerView loggerbird.adapter class.
